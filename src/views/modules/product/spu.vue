<template>
  <div>
    <el-row>
      <el-col :span="24">
        <el-form :inline="true" :model="dataForm">
          ...
          <el-form-item label="品牌">
            <brand-select :brandId.sync="dataForm.brandId" :brands="brands"></brand-select>
          </el-form-item>
      ...
      <el-col :span="24">
        <spuinfo ref="spuinfo" :catId="catId" :dataForm.sync="dataForm"></spuinfo>
      </el-col>
    </el-row>
  </div>
</template>
      ...
      if (path && path.length == 3) {
        ...
        this.$http({
          url: this.$http.adornUrl(
            `/product/brand/list/${path[path.length - 1]}`
          ),
          method: "get",
